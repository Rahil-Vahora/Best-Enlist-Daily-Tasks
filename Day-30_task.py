...
root.title("Calculator @ Dhivya S")
...
clear = Button(root,text="C",width=2,command=clear,bg="orange",fg="white",relief=RIDGE)
...
result = Button(root,text="=",width=10,command=result,bg="green",fg="white",borderwidth=3,relief=RIDGE)
